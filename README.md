...
* [Trois aspects](#trois-aspects)
    ...
    * [La compétition](#la-compétition)
        ...
        * [Tests](#tests-1)
    * [Dépasser les limites de la catégorisation](#dépasser-les-limites-de-la-catégorisation)
* [Les solutions](#les-solutions)
    * [Etudier la tradition pré-Shotokan](#etudier-la-tradition-pré-shotokan)
    * [Travailler en postures naturelles](#travailler-en-postures-naturelles)
    * [Augmenter la diversité technique](#augmenter-la-diversité-technique)
...
2. La mythisation/idéalisation des sensei japonais et des anciens en general qui bloque la remise en cause.
    - Il y a une hypothèse recurrente et séduisante proposant que les maitres d'autrefois aient bénéficié de savoirs
      ...
      Cependant:
        ...
        2. Tous les maitres n'ont probablement pas eu l'expérience de combat de survie et ont pu tomber dans le piège de
           la sophistication ou de l'esthétisation déconnectée de la réalité du combat.
        3. Les compétitions étaient au mieux peu développées (Funakoshi n'était pas d'accord avec l'introduction de la
...
1. Limiter ses techniques à celles des katas et un nombre restreint de techniques approuvées par la hiérarchie.
...
2. L'appui sur les talons qui est contre-intuitif pour du combat pied-poing. L'appui sur les demi-pointes est bien plus
...
3. Les gardes basses et les hikite à la hanche. Biais favorisé par le combat sur une attaque decisive. En combat
   continu, une garde descendue à une distance de corps à corps sera rapidement sanctionnée par une frappe au visage.
4. Les blocages irréalistes sur frappe directe. Souvent pratiqués sur oizuki parce que oizuki est une technique
...
2. Le Shotokan est issue de l'adaptation du karate d'Okinawa au contexte de la metropole japonaise de l'époque:
    ...
    5. L'intention ne pouvant plus être mis sur l'efficacité réelle, le Shotokan s'est developpé selon d'autres axes,
       ...
       autodéfense.
    6. Ces biais ne sont pas negatifs dans l'absolu. Ils ont permis la survie du karaté jusqu'à nos jours, de la même
...
3. Préserver une tradition et une esthétique gestuelle.
...
1. Monter sur un tatami de compétition et faire face dignement pendant un match sans se décomposer.
   C'est apprendre à faire face à la pression et à l'inconnu.
2. Gagner des matchs et des titres.
...
1. Partir de postures naturelles dans la vie de tous les jours:
    - debout bras ballants
    - appuyé contre un mur
    - en marchants
    - assis, etc.
2. Raccourcir les techniques au maximum pour aller droit au but,
3. Abandonner les préparations si elles ne servent pas clairement à parer ou attaquer.
...
2. Il y a un blocage simple à lever aujourd'hui à la FKK: il n'est pas possible de "repasser" un examen de dan dans une
...
3. Plutôt que de contraindre l'interdisciplinarité, il faut la célébrer:
    ...
    2. Créer des competitions ou les participants s'affrontent dans plusieurs disciplines, à la maniere d'un triathlon
       des arts martiaux.
4. J'anticipe l'inquiétude de certains professeurs devant un soudain appel à la diversification:
