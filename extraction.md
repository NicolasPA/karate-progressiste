...
Cet travail s'adresse aux pratiquants qui ont des insatisfactions ou des doutes lorsqu'ils réfléchissent à leur pratique
...
- L'appui sur les talons qui est contre-intuitif pour du combat pied-poing. L'appui sur les demi-pointes est bien plus
  ...
  Explications possibles de l'appui sur les talons :
    ...
    - Le travail sur des mouvements arrêtés pour permettre la verification de la technique et de l'esthétique. Il est
      plus facile de maintenir une position longuement avec les pieds a plats.
...
2. La pedagogie traditionnelle du karate Shotokan pour débutant peut-etre comparée à celle de la danse classique. On
   ...
   environ le niveau 1ère dan. C'est ainsi qu'on peut commencer à se preparer à l'infinité des situations du combat.
...
1. Doit reposer sur l'expérience de professionnels de la securité: policiers, militaires, videurs, stadiers, protection
...
Reference a la Renaissance artistique quand les artistes ont cessé de simplement reproduire les anciens et ont commence
...
comme perdues? Non, il suffit de mettre de côté son égo de karateka et d'aller à la rencontrer d'autres disciplines qui
ont redécouvert ou continué de développer ces techniques, et les ont peaufinées dans des competitions de haut niveau
pour apprendre à leur contact.

C'est d'ailleurs une excellente manière de trouver de nouvelles idees d'interprétation de passages de kata.
Par exemple, nombre de défenses contre saisies enseignees au krav maga peuvent être rapprochées de passages de kata.
Exemple: defense contre une saisie à la gorge sur le debut de heian godan. Encore une fois, il faut mettre de côte son
égo de karateka et considerer que c'est un point fort pour une interpretation que d'exister en dehors du karaté. C'est
...
1. Garde haute, en tous cas au contact, plus la distance est éloignée plus on peut relacher
2. Le travail de défense passif par l'interposition des mains, bras et coudes:
    1. blocage de frappe direct par simple contraction de la grade haut avec tete rentree
...
1. Diagonales avant gauche, avant droite, arrière, en U
...
1. Les katas sont riches de techniques qui evoquent des projections:
    1. L'appui sur les talons peut evoquer un portée de l'adversaire pour une projection.
